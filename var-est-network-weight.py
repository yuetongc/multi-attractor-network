...
stim_mu_var_est_1 = np.max(modelfit.exp_response(stim_x, stim_mu_var_params_1)) \
                    - modelfit.exp_response(stim_x, stim_mu_var_params_1)
stim_mu_var_est_1h = np.max(modelfit.exp_response(stim_x, stim_mu_var_params_1h)) \
                     - modelfit.exp_response(stim_x, stim_mu_var_params_1h)
stim_mu_var_est_2 = np.max(modelfit.exp_response(stim_x, stim_mu_var_params_2)) \
                    - modelfit.exp_response(stim_x, stim_mu_var_params_2)
...
plt.tight_layout()
fig2.savefig('network_weight_effect')
