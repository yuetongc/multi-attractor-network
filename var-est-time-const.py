...
ax1.plot(stim_ticks, stim_mu_coeff_20, color='forestgreen', label=r'$\hat{\tau}_{20}=$'+str(int(stim_mu_coeff_params_20[1]*0.1))+'ms')
...
ax1.set_ylabel(r'$\langle (\alpha_{i}^{\mu})^{2} \rangle_{i}$')
ax1.legend(frameon=False)
ax2.plot(stim_ticks, stim_mu_var_10, color='deepskyblue', label=r'$\hat{\tau}_{10}=$'+str(int(stim_mu_var_params_10[1]*0.1))+'ms')
...
ax2.plot(stim_ticks, stim_mu_var_20, color='royalblue', label=r'$\hat{\tau}_{20}=$'+str(int(stim_mu_var_params_20[1]*0.1))+'ms')
...
ax3.plot(stim_ticks, v_variance_10[start_time:end_time], color='lightcoral', label=r'$\hat{\tau}_{10,r}=$'+str(int(stim_var_est_up_params_10[1]*0.1))+'ms,'+r'$\hat{\tau}_{10,d}=$'+str(int(stim_var_est_down_params_10[1]*0.1))+'ms')
ax3.plot(stim_ticks, stim_v_variance_est_10, color='dimgrey', linestyle='dashed')
...
ax3.plot(stim_ticks, v_variance_20[start_time:end_time], color='orangered', label=r'$\hat{\tau}_{10,r}=$'+str(int(stim_var_est_up_params_20[1]*0.1))+'ms,'+r'$\hat{\tau}_{20,d}=$'+str(int(stim_var_est_down_params_20[1]*0.1))+'ms')
ax3.plot(stim_ticks, stim_v_variance_est_20, color='dimgrey', linestyle='dashed')
...
ax3.plot(stim_ticks, v_variance_30[start_time:end_time], color='firebrick', label=r'$\hat{\tau}_{10,r}=$'+str(int(stim_var_est_up_params_30[1]*0.1))+'ms,'+r'$\hat{\tau}_{30,d}=$'+str(int(stim_var_est_down_params_30[1]*0.1))+'ms')
ax3.plot(stim_ticks, stim_v_variance_est_30, color='dimgrey', linestyle='dashed')
...
ax4.plot(stim_ticks, mu_grad_params_const_10_est[start_time:end_time], color='darkgray', label=r'$\hat{\tau}_{10,r}=$'+str(int(stim_v_variance_up_params_10[1]*0.1))+'ms,'+r'$\hat{\tau}_{10,d}=$'+str(int(stim_v_variance_down_params_10[1]*0.1))+'ms')
ax4.plot(stim_ticks, stim_v_est_est_10, color='dimgrey', linestyle='dashed')
...
ax4.plot(stim_ticks, mu_grad_params_const_20_est[start_time:end_time], color='grey', label=r'$\hat{\tau}_{20,r}=$'+str(int(stim_v_variance_up_params_20[1]*0.1))+'ms,'+r'$\hat{\tau}_{20,d}=$'+str(int(stim_v_variance_down_params_20[1]*0.1))+'ms')
ax4.plot(stim_ticks, stim_v_est_est_20, color='dimgrey', linestyle='dashed')
...
ax4.plot(stim_ticks, mu_grad_params_const_30_est[start_time:end_time], color='dimgrey', label=r'$\hat{\tau}_{30,r}=$'+str(int(stim_v_variance_up_params_30[1]*0.1))+'ms,'+r'$\hat{\tau}_{30,d}=$'+str(int(stim_v_variance_down_params_30[1]*0.1))+'ms')
ax4.plot(stim_ticks, stim_v_est_est_30, color='dimgrey', linestyle='dashed')
